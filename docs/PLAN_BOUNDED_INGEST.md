...
> | 0c | target-shape coefficients at 1M and 2M x 3.2 KB | **wip** - measured at 100k, 200k and 400k x 3.2 KB, both arms, in MEMORY_MODEL §9.9, and the bulk-load arm added at 25k-400k in §9.11. The quadratic is a measurement: amplification 6.53x -> 11.77x -> 21.24x, **1.80x per doubling, twice**, against the unbounded arm's flat 1.81x and linear memory. Phase 5 is needed, and is now built. 1M and 2M outstanding - ~805 GiB of writes between them, which the 20 GiB testing ceiling in force on 2026-09-17 rules out by an order of magnitude |
